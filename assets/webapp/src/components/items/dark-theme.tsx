...
const DarkTheme: React.FC = () => {
    return (
        <div
            className="items-center rounded-md border-2 border-foreground border-muted bg-popover p-1 hover:bg-accent hover:text-accent-foreground  w-full lg:w-[200px]">
